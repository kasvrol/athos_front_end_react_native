...
export const ModalGerenciarPartida = ({ visible, onClose, onSave, partida }: ModalGerenciarPartidaProps) => {
    ...
    >
      ...
      >
        ...
        >
            ...
            <Button height={'$minWidth'} width={'$minWidth'} chromeless icon={X} onPress={onClose} color="$color" />
          </XStack>
          <XStack justifyContent="center" width={'100%'}>
            <H3 textAlign='center' fontSize="$6" color="$color9" fontWeight={'700'}>Gerenciar Placar</H3>
          </XStack>
          ...
          <XStack alignItems="center" justifyContent="space-between" gap="$2">
            ...
            <Text fontSize="$6" fontWeight="bold" color="$color5">X</Text>
          ...
          <XStack alignItems="center" justifyContent="space-between" backgroundColor="$backgroundPress" padding="$3" borderRadius="$3">
