    ...
    <LayoutDefault>
        <YStack alignItems="center" gap="$4" marginTop={50} paddingBottom="$8">
            ...
            <YStack alignItems="center" gap="$3">
                <H2 color="$color10" fontWeight="bold">{userData.nome}</H2>
            </YStack>
            ...
            <YStack width="100%" gap="$4" paddingHorizontal="$4">
                ...
                <XStack gap="$3" alignItems="center">
                    ...
                    <YStack>
                        <Text color="$color5" fontSize="$3">E-mail</Text>
                        <Text color="$color" fontSize="$5">{userData.email}</Text>
                    </YStack>
                </XStack>
                ...
                <XStack gap="$3" alignItems="center">
                    ...
                    <YStack flex={1}>
                        <Text color="$color5" fontSize="$3">Bairros de Interesse</Text>
                ...
                <XStack gap="$3" alignItems="center">
                    ...
                    <YStack flex={1}>
                        <Text color="$color5" fontSize="$3">Esportes Favoritos</Text>
                        <Text color="$color" fontSize="$5" flexWrap="wrap">
