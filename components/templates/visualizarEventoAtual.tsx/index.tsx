...
import { AvaliarOrganizador } from '@/components/organisms/listarOrganizador'
  ...
  return (
    <LayoutDefault>
      ...
      <YStack paddingBottom={'$4'}>
        <EventScreen dadosEvento={dadosEvento} statusEvento={StatusEvento.OCORRENDO} />
        {user?.id === dadosEvento.organizador.idOrganizador ? (
          <ListarParticipantes
          ...
          <AvaliarOrganizador
            nomeOrganizador={dadosEvento.organizador.nomeOrganizador}
            avaliacaoOrganizador={dadosEvento.organizador.avaliacaoOrganizador}
            idOrganizador={dadosEvento.organizador.idOrganizador}
          />
        )}
      </YStack>
    </LayoutDefault>
