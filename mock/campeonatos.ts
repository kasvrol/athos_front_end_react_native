...
export const mockEquipes: Equipe[] = [
  { id: 'equipe-1', nome: 'Os Velozes', capitaoId: 'user-capitao-1', campeonatoId: 'camp-1', membros: mockMembrosEquipe1, createdAt: '2025-10-01' },
  { id: 'equipe-2', nome: 'Furiosos FC', capitaoId: 'user-capitao-2', campeonatoId: 'camp-1', membros: mockMembrosEquipe2, createdAt: '2025-10-01' },
  { id: 'equipe-3', nome: 'Raio FC', capitaoId: 'user-capitao-3', campeonatoId: 'camp-1', membros: mockMembrosEquipe3, createdAt: '2025-10-05' },
  { id: 'equipe-4', nome: 'Trovão Azul', capitaoId: 'user-capitao-4', campeonatoId: 'camp-1', membros: mockMembrosEquipe4, createdAt: '2025-10-06' },
  { id: 'equipe-5', nome: 'Vôlei Masters', capitaoId: 'user-capitao-5', campeonatoId: 'camp-2', membros: [{ usuarioId: 'user-capitao-5', nomeUsuario: 'Laura (Capitã)', dataEntrada: '2025-10-10' }], createdAt: '2025-10-10' },
  { id: 'equipe-6', nome: 'Sacadores', capitaoId: 'user-capitao-6', campeonatoId: 'camp-2', membros: [{ usuarioId: 'user-capitao-6', nomeUsuario: 'Marcos (Capitão)', dataEntrada: '2025-10-11' }], createdAt: '2025-10-11' },
];
...
export const mockCampeonatos: Campeonato[] = [
  {
    ...
    maxEquipes: 8,
    equipesInscritas: 4,
    descricao: 'A primeira copa oficial de Futebol 7 da plataforma Athos. Reúna sua equipe e venha competir pelo troféu!',
